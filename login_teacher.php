...
<body class="text-center login-body">
  ...
  <main class="form-signin">
      ...
      <div class="form-floating">
        <input type="password" id="password-login" class="form-control" placeholder="Password">
        <label for="password-login">Wachtwoord</label>
      </div>

      <button class="w-100 btn btn-lg btn-primary" id="teacher-login" type="submit">Log in</button>
  </main>
