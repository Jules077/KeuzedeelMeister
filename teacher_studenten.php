  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="teacher_studenten.php">
                Studenten
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="teacher_semesters.php">
                Semesters
            </a>
          </li>
        </ul>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <table class="table table-striped table-sm">
          ...
          <tbody>
            <tr>
              <td contenteditable="true">81739</td>
              <td contenteditable="true">Jules</td>
              <td contenteditable="true"></td>
              <td contenteditable="true">Zwarts</td>
              <td contenteditable="true">2002-05-04</td>
              <td contenteditable="true">IC.18AO.E</td>
