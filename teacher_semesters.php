    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="teacher_klassen.php">
                Klassen
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="teacher_semesters.php">
                Semesters
            </a>
          </li>
        </ul>
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Keuzedeel</th>
              <th scope="col">Docent</th>
              <th scope="col">Studenten plekken</th>
          ...
          <tbody>
            <tr>
              ...
              <td contenteditable="true">2021-02-01</td>
              <td contenteditable="true">2021-08-01</td>
              <td contenteditable="true">1223</td>
              <td contenteditable="true">Kals</td>
              <td contenteditable="true">20</td>
              <td><button type="button" class="btn btn-outline-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
            ...
            <tr>
              ...
              <td contenteditable="true">2021-02-01</td>
              <td contenteditable="true">2021-08-01</td>
              <td contenteditable="true">44444</td>
              <td contenteditable="true">Kals</td>
            ...
            <tr>
              ...
              <td contenteditable="true">2021-02-01</td>
              <td contenteditable="true">2021-08-01</td>
              <td contenteditable="true">33333</td>
              <td contenteditable="true">Kals</td>
